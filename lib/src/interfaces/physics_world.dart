...
abstract class PhysicsWorld
  ...
  /// Destroy this world and invalidate all bodies, colliders and borrowed views.
  /// Detaches the event listener, which remains caller-owned. Idempotent.
  void dispose();

  /// Advance by a finite positive timestep in seconds; prefer fixed steps.
  ...
  /// Register automatic events, delivered asynchronously after update returns.
  /// The caller owns the listener. World disposal detaches it but does not dispose it.
