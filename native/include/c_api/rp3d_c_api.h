...
EMSCRIPTEN_KEEPALIVE void rp3d_collider_set_collision_category_bits(RP3D_Collider* collider, uint16_t collisionCategoryBits);
EMSCRIPTEN_KEEPALIVE uint16_t rp3d_collider_get_collision_category_bits(const RP3D_Collider* collider);

EMSCRIPTEN_KEEPALIVE void rp3d_collider_set_collide_with_mask_bits(RP3D_Collider* collider, uint16_t collideWithMaskBits);
EMSCRIPTEN_KEEPALIVE uint16_t rp3d_collider_get_collide_with_mask_bits(const RP3D_Collider* collider);
